...
final Uri updateAttributeStatusAPI =
    Uri.parse("${baseUrl}update_attribute_status");
...
final Uri updateRestaurantTimeAPI =
    Uri.parse("${baseUrl}update_restaurant_time");
...
final Uri searchLocationUrl = Uri.parse("${baseUrl}search_location");
final Uri getLocationDetailsUrl = Uri.parse("${baseUrl}get_location_details");
// ==============New=========
